...
if not csv_files:
    ...
    print(
        "Please download the 'Users who have VAN Access' list from VAN as a CSV and drop it in this folder."
    )
    exit(1)
...
with open("js/chair_data.js", encoding="utf-8") as f:
    content = f.read()
...
print(
    f"Success! Automatically updated {updated_count} precinct chairs to 'Has Access' based on the VAN CSV."
)
