...
exclude_list = [
    ...
    "events.html",
    "volunteer.html",
    "precinct_lookup.html",
    "demographic_map.html",
    "issues_map.html",
    "interactive_precincts.html",
    "political_strategy_dashboard.html",
    "admin_dashboard.html",
    "volunteer_dashboard.html",
    "hidalgo_orbital_gallery.html",
    "mockup_c_dashboard.html",
    "visualizations_demo.html",
    "live_results.html",
    "social_wall.html",
    "van_resources.html",
    "college_dems_social_template.html",
    "get_error.html",
    "iphone_preview.html",
    "logistics_experiment.html",
    "lupe_marcha_email_template.html",
    "lupe_marcha_preview.html",
    "lupe_marcha_preview_nonchair.html",
    "mockup_a_reskin.html",
    "mockup_b_pwa.html",
    "option4_classic.html",
    "stc_dems_recruitment_template.html",
    "stonewall_rgv_experiment.html",
    "test_browser.html",
    "test_deploy.html",
    "test_images.html",
    "young_dems_meeting_template.html",
    "chat.html",
    "civics_101.html",
    "civics_102.html",
    "civics_pretext_experiment.html",
    "clarity_page.html",
    "county_websites.html",
    "early_voting_analysis_paper.html",
    "internships.html",
    "maverick_county_mockup.html",
    "option2_rio_grande.html",
    "precinct_completion.html",
    "precinct_performance.html",
    "sitemap.html",
]
...
for file_path in html_files:
    ...
    match = re.search(
        r'<div class="tx-clone-content-inner[^>]*>(.*?)</div>\s*</section>',
        content,
    ...
    if not match:
        ...
        if match:
            ...
            body_content = re.sub(
                r"<nav.*?</nav>", "", body_content, flags=re.IGNORECASE | re.DOTALL
            )
            body_content = re.sub(
                r"<footer.*?</footer>",
                "",
...
menu_html = menu_html.replace(
    'href="menu.html" class="tab-item"', 'href="menu.html" class="tab-item active"'
)
menu_html = menu_html.replace(
    'href="index.html" class="tab-item active"', 'href="index.html" class="tab-item"'
)
