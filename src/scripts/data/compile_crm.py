...
try:
    with open("data/McAllen Signups.csv", encoding="utf-8") as f:
...
try:
    with open("data/curated_community_volunteers.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            add_contact(
...
try:
    with open("data/curated_talarico_new_recruits.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            add_contact(
                first=row.get("FirstName", ""),
...
try:
    with open("data/curated_undisclosed_list.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            add_contact(
                first=row.get("FirstName", ""),
...
try:
    with open("data/old volunteer list 24-25.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            add_contact(
...
try:
    with open("data/top_tier_democrats.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            add_contact(
                first=row.get("First Name", ""),
...
# 7. young_dems.csv
try:
    with open("data/young_dems.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            add_contact(
                first=row.get("First Name", ""),
...
try:
    with open("HCDP_Precinct_Contacts.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
            add_contact(
                first=row.get("first", ""),
...
# 9. new_chairs.tsv
try:
    with open("new_chairs.tsv", encoding="utf-8") as f:
        for line in f:
...
try:
    with open("data/emaildatasettest/p192_non_voters.csv", encoding="utf-8") as f:
        reader = csv.DictReader(f)
        for row in reader:
...
try:
    with open("data/master_candidates_2026.json", encoding="utf-8") as f:
        data = json.load(f)
        for item in data:
            add_contact(
...
try:
    with open(
        "data/judicial_candidates_and_officials.json", encoding="utf-8"
    ) as f:
        data = json.load(f)
        for item in data:
            add_contact(
