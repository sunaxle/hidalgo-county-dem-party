...
# Load JSON
with open("data/judicial_candidates_and_officials.json") as f:
...
with open("elected_officials.html") as f:
    html = f.read()

# Add button
button_target = (
    '<button class="tab-btn" data-target="tab-state">Texas Legislature</button>'
)
