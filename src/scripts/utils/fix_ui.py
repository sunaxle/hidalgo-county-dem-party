...
with open("js/precinct_hub.js", encoding="utf-8") as f:
    hub_js = f.read()
...
with open("hidalgo-election-map/map_chairs.js", encoding="utf-8") as f:
    map_js = f.read()
...
with open("precinct_chairs.html", encoding="utf-8") as f:
    html = f.read()
...
html = html.replace(
    '<td><span class="pct-badge">${person.precinct}</span></td>', row_replace
)
