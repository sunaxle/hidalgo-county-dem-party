...
def update_district(p):
    ...
    if pid in splits:
        p["CD"] = (
            "SPLIT"  # Or assign to one for math purposes? The dashboard has a toggle button for 15 and 28. If we assign "15|28", the map filter might break if it expects exact equality. Let's look at the JS.
        )
