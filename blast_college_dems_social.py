...
TEMPLATE_FILE = "college_dems_social_template.html"
TARGET_CSV = "data/young_dems.csv" # Update this to your sign-ups CSV file path if different

def load_template():
    with open(TEMPLATE_FILE, "r", encoding="utf-8") as f:
        return f.read()

def send_email(recipient_name, recipient_email, sender_email, server, template_html, is_dry_run=True):
    subject = "🎉 You're Invited: RGV College Dems End of Semester Social!"
...
if __name__ == "__main__":
    ...
    if is_dry_run:
        ...
        print("python3 blast_college_dems_social.py send")
