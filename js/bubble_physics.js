function initBubblePhysics() {
  ...
  const mockIssues = [
    {
      ...
      color: "#facc15",
      stat: "Streetlights",
      text: "The top issue we hear at the doors is the lack of working streetlights causing safety concerns.",
    },
    {
      category: "Infrastructure",
      color: "#facc15",
      stat: "Potholes",
      text: "Residents are frustrated with the city patching phase. Coordination between city and county road crews is our top request.",
    },
    {
      category: "Infrastructure",
      color: "#facc15",
      stat: "Drainage",
      text: "Even light rain floods the corner intersections. We need county drainage bonds prioritized for our neighborhood.",
    },
    {
      category: "Public Safety",
      color: "#ef4444",
      stat: "Stray Dogs",
      text: "Animal control response times are too slow. Packs of loose dogs are terrifying families walking to school.",
    },
    {
      category: "Public Safety",
      color: "#ef4444",
      stat: "Speeding",
      text: "We desperately need speed bumps installed near the elementary school drop-off zones.",
    },
    {
      category: "Economics",
      color: "#10b981",
      stat: "Property Taxes",
      text: "Appraisal hikes are squeezing working class families. We need to educate voters on homestead exemptions.",
    },
    {
      category: "Logistics",
      color: "#a855f7",
      stat: "Polling Access",
      text: "We need an early voting location re-opened at the community center; transport is too difficult for seniors.",
    },
  ];
  ...
  const simulation = d3
    ...
    .force(
      ...
      d3
        ...
        .radius((d) => d.radius + 3)
        .iterations(4),
    ) // Tight collision geometry (+3px buffer)
  ...
  setTimeout(() => {
    if (document.getElementById("stat-total-issues")) {
      ...
      document.getElementById("stat-infra").innerText =
        catCounts["Infrastructure"];
      document.getElementById("stat-safety").innerText =
        catCounts["Public Safety"];
