...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    console.log(
      "🚀 Payload ready for Google Sheets Webhook / VAN Bulk Upload:",
    );
    console.table(payload);

    // 3. Send POST Request to Google Apps Script Webhook
    const WEBHOOK_URL =
      "https://script.google.com/macros/s/AKfycbwPi82fwnMQxQjuw961LgB7UXQ8tB5_KJsdyM2cxKbXrAWM13-Ylrgm7Nz6H3a7MIge/exec";
    ...
    try {
      ...
      alert(
        "There was an error connecting to the database. Please try again or email us directly.",
      );
    } finally {
      // Reset button
