        ...
        if (user) {
            ...
            loginContainer.innerHTML = `
                <div class="user-profile" style="display: flex; align-items: center; gap: 8px;">
                    ...
                    <button id="btn-logout" class="btn-donate-sm" style="background: #475569; color: white; padding: 0.5rem 1rem; border-radius: 9999px; font-weight: 800; font-size: 0.85rem; border: none; cursor: pointer;">LOGOUT</button>
                </div>
            `;
            ...
            // User is signed out
            loginContainer.innerHTML = `
                <button id="btn-login" class="btn-donate-sm" style="background: white; color: var(--hcdp-blue, #0f172a); display: flex; align-items: center; gap: 5px; padding: 0.5rem 1rem; border-radius: 9999px; font-weight: 800; font-size: 0.85rem; border: none; cursor: pointer;">
