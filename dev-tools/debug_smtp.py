...
def run_diagnostic():
    ...
    msg = EmailMessage()
    msg.set_content(
        "This is a system diagnostic message to verify SMTP routing and Google inbound reception protocols."
    )
    ...
    try:
        ...
        print(
            "If the massive text block above ended with a '250 OK Message accepted' code, it means the server successfully wired it exactly where it was supposed to go. If it still didn't arrive, Google is actively throttling it as spam."
        )
