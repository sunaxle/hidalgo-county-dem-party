...
def send_mac_text():
    ...
    phone_number = input(
        "Enter your own cell phone number to test (e.g., 9566387581): "
    ).strip()
    ...
    if result == 0:
        ...
        print(
            "Open your Messages app on your Mac—you should physically see the text in your sent history!"
        )
    else:
        print(
            "❌ ERROR: The AppleScript failed to execute. Ensure your Messages app is open and configured."
        )
