...
def send_test_blast():
    ...
    test_email = input(
        "Enter your personal email address to receive the test: "
    ).strip()
    if not test_email:
    ...
    try:
        ...
        print(
            f"Error: {template_path} not found. Are you running this from dev-tools/?"
        )
        return
    ...
    try:
        ...
        for email_addr in email_list:
            ...
            msg["To"] = email_addr
            msg.set_content(
                "If you are seeing this, your email client does not support HTML. Please view in a modern client."
            )
        ...
        print(
            "Check your inbox (and your spam folder just in case). If it landed, the engine is fully operational!"
        )
