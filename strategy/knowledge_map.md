...
graph TD
    %% Core Leadership
    Chair[Richard Gonzales<br>County Chair]
    DirOps["[Your Role]<br>Number 2/3 / Data Director"]
    ED[Abraham Sanchez<br>Executive Director]

    %% Old Guard / Pro-Chair Faction
    subgraph OldGuard[The Pro-Chair Faction / Old Admin Board]
        Whip[Irma Garcia<br>The Whip / Chief of Staff]
        Org[Alma Garcia<br>Mission P-Chair]
        Tech[Ezekiel<br>Tech & A/V]
        Legal[Kenna Giffin<br>Attorney/Treasurer]
        SDEC[Laurel McLeish<br>SDEC Member]
        Sage[Oscar 'Big O'<br>Advisor]
    end

    %% External & Regional Factions
    subgraph HostileTakeover[The Aggressive Faction]
        MFD[Melissa Holomo, Stacy Solis, Eddie De La Rosa<br>~30 Precinct Chairs & Followers]
    end

    subgraph RegionalFactions[Regional & Issue Factions]
        South[Mildred<br>City of Hidalgo]
        Prog[Alma De La Rosa<br>Edinburg / Progressives]
        LGBTQ[Paul Basaldua<br>LGBTQ / Pro-Unification]
        YoungDems[The Young Dems Coalition<br>UTRGV, STC = ~31 Strong]
    end
    ...
    LGBTQ -. "Trying to Unify" .- Chair
    Chair --- YoungDems
    
    classDef oldguard fill:#1f77b4,stroke:#fff,stroke-width:2px,color:#fff;
    classDef conflict fill:#d62728,stroke:#fff,stroke-width:2px,color:#fff;
    classDef warning fill:#ff7f0e,stroke:#fff,stroke-width:2px,color:#fff;
    classDef neutral fill:#2ca02c,stroke:#fff,stroke-width:2px,color:#fff;
    
    class Whip,Org,Legal,SDEC,Comms,Coord,Sage,Tech oldguard;
    class MFD conflict;
    class ED warning;
    class South,Prog,LGBTQ,YoungDems neutral;
```
