...
<div class="container">
  ...
  <div class="content">
    ...
    <div class="gif-container">
      <!-- UPDATE THIS LINK to where your GIF is hosted! -->
      <img src="https://via.placeholder.com/800x600.png?text=Animated+VAN+Tutorial+Plays+Here" alt="VAN Tutorial">
    </div>
    <p>We have two options to help you mobilize your neighborhood this weekend:</p>
    <div>
      <a href="mailto:chair@hidalgocountydemocraticparty.org?subject=I%20want%20VAN%20Access!" class="btn btn-primary">🎓 Set up my VAN Account</a>
      <!-- UPDATE THIS LINK to where van_concierge.html is hosted! -->
      <a href="https://yourwebsite.com/van_concierge.html" class="btn btn-secondary">🚀 I'm too busy, just cut my list for me</a>
    </div>
  </div>
