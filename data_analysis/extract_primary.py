                ...
                if line.startswith("Cast Votes:"):
                    ...
                    if len(parts) >= 8:
                        try:
                            ...
                            if current_precinct:
                                if ev_votes > precinct_totals[current_precinct].get(
                                    "early_voting", 0
                                ):
                                    precinct_totals[current_precinct][
                                        "early_voting"
                                    ] = ev_votes
                                if ed_votes > precinct_totals[current_precinct].get(
                                    "election_day", 0
                                ):
                                    precinct_totals[current_precinct][
                                        "election_day"
                                    ] = ed_votes
                                if total_votes > precinct_totals[current_precinct].get(
                                    "total_turnout", 0
                                ):
                                    precinct_totals[current_precinct][
                                        "total_turnout"
