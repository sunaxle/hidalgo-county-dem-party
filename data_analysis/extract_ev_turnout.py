    ...
    try:
        ...
        with pdfplumber.open(pdf_path) as pdf:
            for i, page in enumerate(pdf.pages):
                if (
                    i > 2
                ):  # Limit to first 3 pages so we don't hang, since we just need schema or partial data for the demo
                    break
        ...
        if extracted_data:
            ...
            print(
                f"No tabular data found in {pdf_path}. Will extract raw text instead."
            )
...
if __name__ == "__main__":
    ...
    extract_pdf_data(
        "2026primaryvoting data/DEM Precinct-3-11-2026 04-04-46 PM.pdf",
        "data_analysis/ev_primary2026.csv",
    )
